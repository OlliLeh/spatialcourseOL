...
```{r}
library(spatialreg)
m2e <-errorsarlm(tyottom~ korkk+alkut+elak+as_tih+he_kika.x+ra_as_kpa.y, data=data2, p22_kn6_w, tol.solve=1.0e-30)
...
moran.mc(data2$residuals, p22_kn6_w,999)
```

## 12. Spatial Lag Model (SLM)

```{r}
m2lag <- lagsarlm(tyottom~ korkk+alkut+elak+as_tih+he_kika.x+ra_as_kpa.y, data=data2, p22_kn6_w, tol.solve=1.0e-30)
...
moran.mc(data2$residuals_lag, p22_kn6_w,999)
```
