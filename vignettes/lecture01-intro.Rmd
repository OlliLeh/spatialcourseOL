...
---
title: "Open Data: Open Data: Reading an Excel File from the Web and Mapping Municipal Groups in Finland"
output: html_document
---

This example demonstrates how to:

Download an Excel file directly from an online source
Read it into R
Clean and prepare the data
Join it with official municipal boundaries
