...
Join this dataset in R with the municipality dataset downloaded from the geofi package. You can save the key figures as a CSV table in your own directory and then import the data into R.
You can import the CSV table into R, for example, using the read.csv function:
...
workplace self-sufficiency, and
share of persons with tertiary-level education (persons aged 15 or over, %).
