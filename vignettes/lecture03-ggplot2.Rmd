...
Reading a CSV file
``` {r}
dat<-read.csv("D:/UEF 2018/HANKKEET/Ravit ytr 2022/aluejaot2.csv", sep=",",encoding="UTF-8", stringsAsFactors=FALSE) 
names(dat)
```
...
```{r}
data = read.csv("D:/UEF 2018/GIS mallinnus II 2024/14.3.2024 johdatus visualisointi//data_vakie3.csv", sep=",",
