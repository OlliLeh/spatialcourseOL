...
Tasks:
-	Interpret the resulting clusters (e.g. high–high, low–low).
-	Explain what these clusters reveal about the spatial distribution of household income.
...
(Share of highly educated = number with academic degrees / number of educated people)

Tasks:
-	Interpret the regression coefficients.
-	Evaluate whether the results are consistent with economic intuition.
-	Investigate the spatial autocorrelation of the model residuals (e.g. using Moran’s I).
-	Explain what the residual spatial autocorrelation indicates about the adequacy of the OLS model.
...
-	Compare the spatial regression model with the OLS model from Exercise 3.
-	Assess whether the spatial model provides an improvement over the OLS model and justify your conclusion.
